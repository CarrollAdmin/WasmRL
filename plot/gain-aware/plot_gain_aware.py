...
file2_data = []
with open("reward_2mm_ours.txt", "r") as file2:
    for line in file2:
        _, reward = line.strip().split(": ")
...
ax1.plot(x, file1_data, label="ours w/o. gain-aware reward", linewidth=3, color=color[0], alpha=1)
ax1.plot(x, file2_data, label="ours w. gain-aware reward", linewidth=3, color=color[1], alpha=1)
